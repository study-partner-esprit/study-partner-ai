...
class ContentRetriever:
    ...
    def __init__(self, vector_store, embed_model, chunk_size: int = 800, overlap: int = 50):
        """
    ...
    def add_documents(self, documents: List[str], tokenization_settings: Optional[dict] = None) -> int:
        """
        ...
        if tokenization_settings:
            chunk_size = tokenization_settings.get('chunk_size', self.tokenizer.chunk_size)

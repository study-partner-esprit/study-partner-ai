...
def normalize_course(course_title: str, subtopics: list, source_files: list) -> CourseKnowledgeJSON:
    """
    ...
    topic = Topic(
        id="topic_1",
        title=course_title,
        summary=" ".join(sub.summary for sub in subtopic_objects if sub.summary)[:1000],  # Combine summaries

...
class ReviewMetadata(BaseModel):
    ...
    original_task_id: str = Field(..., description="ID of the original task being reviewed")
    ...
    review_number: int = Field(default=1, description="Which review iteration this is (1st, 2nd, 3rd...)")
    interval_days: int = Field(..., description="Days since original completion or last review")
    ...
    class Config:
        json_schema_extra = {
            "example": {
                ...
                "ease_factor": 2.5,
                "quality_score": 4,
                "key_concepts": ["variable declaration", "type casting", "naming conventions"],
